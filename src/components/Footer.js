            ...
            <div className="container mx-auto px-6 py-4">
                <div className="flex justify-between items-center text-gray-600">
                    ...
                    <div className="flex items-center -mx-2">
                        ...
                        <a className="flex items-center mx-2 hover:text-blue-500 ease-in-out duration-200" href="https://linkedin.com/in/Jasius">
                            <svg className="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26px" height="26px">
                        ...
                        <a className="flex items-center mx-2 hover:text-blue-500 ease-in-out duration-200" href="https://github.com/Jasius">
                            <svg className="h-5 w-5 fill-current" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
