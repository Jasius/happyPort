        ...
        <section className="bg-white m-10 lg:m-20">
            <div className="flex mx-auto max-w-screen-md">
                <div className="lg:block hidden">
                    <div className="h-48 w-48 bg-cover rounded-full border-solid border-2 border-green-600 flex items-center justify-center overflow-hidden" title="Profile picture" style={{ backgroundImage: `url('https://jaska.dev/jaska.b4e4c830.png')` }}></div>
                </div>
