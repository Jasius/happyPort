        ...
        <section className="m-10 lg:m-20">
            <div className="flex mx-auto max-w-screen-md">
                <div className="lg:block hidden">
                    <div className="h-48 w-48 bg-cover shadow-lg rounded-full border-solid border-2 border-blue-600 flex items-center justify-center overflow-hidden" title="Profile picture" style={{ backgroundImage: `url('assets/img/jaska.png')` }}></div>
                </div>
                <div className="lg:ml-6">
                    ...
                    <p className="text-gray-600 mt-4">I am a 23 years old ambitious front end developer who currently works in a flex role as internal tools developer, QA engineer and resides in a beautiful <a className="text-blue-600 underline" href="https://govilnius.lt">Vilnius city.</a> Before going back to live in Vilnius <a className="text-blue-600 underline" href="https://www.linkedin.com/posts/jasius_covid19-military-army-activity-6654753774902493184-bCm_">I served as a conscript soldier</a> in Marijampole's logistics battalion where I was assigned to SEP operator duties.
