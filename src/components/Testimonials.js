            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div class="max-w-md px-8 bg-white shadow-lg rounded-lg py-10 bg-opacity-25">
                    <div class="flex justify-center">
                        <img class="w-20 h-20 object-cover rounded-full border-2 border-blue-600" src="https://jaska.dev/karolisN.d6da2a08.png" />
                    </div>
                    <div>
                        ...
                        <h3 class="text-gray-800 text-1xl ">Delivery Ops Lead</h3>
                        <p class="mt-4 italic text-gray-600">Thanks for all the improvements, amazing work on internal tool and constant technical help!</p>
                    </div>
                </div>
                <div class="max-w-md px-8 bg-white shadow-lg rounded-lg py-10 bg-opacity-25">
                    <div class="flex justify-center">
